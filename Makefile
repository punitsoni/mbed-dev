...
OBJS = main.o test.o
OUT_DIR = out
OBJECTS = $(addprefix $(OUT_DIR)/, $(OBJS))
...
INCLUDE_PATHS = -I. -I./mbed -I./mbed/TARGET_NUCLEO_F103RB \
                -I./mbed/TARGET_NUCLEO_F103RB/TOOLCHAIN_GCC_ARM \
                -I./mbed/TARGET_/TARGET_STM \
                -I./mbed/TARGET_NUCLEO_F103RB/TARGET_STM/TARGET_NUCLEO_F103RB
...
CC_FLAGS += -MMD -MP
CC_SYMBOLS = -DTARGET_NUCLEO_F103RB -DTARGET_M3 \
             -DTARGET_STM -DTOOLCHAIN_GCC_ARM -DTOOLCHAIN_GCC \
             -D__CORTEX_M3 -DARM_MATH_CM3 \
             -DMBED_BUILD_TIMESTAMP=1400548239.15 -D__MBED__=1
...
$(OUT_DIR)/$(PROJECT).elf: $(OBJECTS) $(SYS_OBJECTS)
	@printf "%-10s $@\n" [LD]
